...
class Paciente {
    constructor(apellido, nombre, calle, numero, cpa, telefono, dni, localidad) {
        ...
        this.dni = dni;
        this.domicilio = `${calle} ${numero} CPA ${cpa} Localidad ${localidad}`;
    }
}
class Profesional {
    constructor(
...
const turnosLibres = (opcion) => {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    // ERROR                                                                                            //
    // CUANDO TRAE LOS TURNOS LIBRES SI HAY MAS DE UN SEGMENTO DE TURNOS EN EL DIA SOLO ELIGE EL ULTIMO //
    // HAY QUE REVEER ESO                                                                               //
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    let horarios =
        ...
        ]; //esto esta mal hay que ver comohacer paraque agarre todoslos array excepto el indice 0
    let libres = [];
    let numero = 1;
    libres[0] = "0 - Salir";
...
const telefonoPaciente = error => {
    let regexTelefono = /\([0-9]{3}[0-9]?[0-9]?\)[-]?([0-9]{2})?[0-9]?[-]?[0-9]{2}[0-9]?[-]?[0-9]{4}/g;
...
bbb puede ser de 2 o 3 caracteres`);
    ...
    if (condicion) {
        PacienteObj.telefono = telefono
    } else telefonoPaciente(true)
};

const configurarPaciente = () => {
    PacienteObj.apellido = prompt("Apellido del paciente:").toUpperCase();
    ...
    PacienteObj.direccion.calle = prompt("Calle donde vive:");
    PacienteObj.direccion.numero = prompt("Altura de la calle:");
    PacienteObj.direccion = prompt("Codigo postal");
    PacienteObj.direccion.localidad = prompt("Localidad");
};
//////////////////////////////////////////
// LOGICA PRINCIPAL                     //
//////////////////////////////////////////
